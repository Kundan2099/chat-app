    ...
    <figure class="panel-card">
        <div class="panel-card-body">
            <div class="space-y-3">
                <div>
                    <div class="h-[50px] w-[50px] bg-complement rounded-full flex items-center justify-center text-ascent">
                        <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" height="1.5em" width="1.5em" xmlns="http://www.w3.org/2000/svg"><path d="M20 7h-9"></path><path d="M14 17H5"></path><circle cx="17" cy="17" r="3"></circle><circle cx="7" cy="7" r="3"></circle></svg>
                    </div>
                </div>
                <div>
                    <h1 class="title-lg">System Preference</h1>
                    <p class="description">Manage the system preference</p>
                </div>
                <div>
                    <a href="{{route('admin.view.setting.preference')}}" class="link text-sm flex items-center space-x-2">
                        <span>Manage Prefrences</span>    
                        <i data-feather="edit" class="h-3 w-3 stroke-[2.5px]"></i>
                    </a>
                </div>
            </div>
